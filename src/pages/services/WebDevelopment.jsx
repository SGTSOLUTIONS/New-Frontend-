...
const webDevelopmentFeatures = [
    {
        ...
        description: "Fully responsive, mobile-first websites that reflect your brand identity. Clean UI/UX, intuitive navigation, and conversion-focused layouts.",
    ...
    },
    {
        ...
        description: "Secure online stores with product catalogs, payment gateways, inventory management, and order tracking — built on WooCommerce or custom solutions.",
    ...
    },
    {
        id: 3,
        icon: "fa-database",
        title: "Web GIS & Mapping Portals",
        description: "Interactive map dashboards, spatial data visualization, and location-based services using Leaflet, Mapbox GL, OpenLayers, or Esri JS API.",
        image: webDevFeature3,
        link: "/services/web-development/webgis",
    },
    {
        id: 4,
...
const testimonials = [
  {
    ...
    text: 'SGT Solutions delivered a comprehensive web GIS portal for property management and revenue tracking, enabling seamless access to spatial data for administrators.',
    img: testimonial1
  },
  {
    id: 2,
    ...
    role: 'Envato Author',
    text: 'SGT Solutions developed a custom web platform for environmental monitoring, integrating interactive maps and real-time data visualization.',
    img: testimonial2
  },
  {
    id: 3,
    ...
    role: 'Envato Author',
    text: 'SGT Solutions created a web-based water resource management system with integrated GIS capabilities for data analysis and reporting.',
    img: testimonial3
  },
];
...
const blogs = [
  ...
  {
    id: 2,
    title: 'Web GIS: Bringing Maps to the Browser',
    date: '20 March, 2021',
    author: 'Keesler Smith',
    img: blog2,
...
const WebDevelopment = () => {
  ...
  padding: 0 20px;
        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="hero-description">
              Custom websites, web applications, and digital platforms — modern, responsive, and built for performance. 
              From corporate sites to complex geospatial web portals.
            </p>
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <button onClick={() => setShowModal(true)} className="berpo_btn">
                Start Your Web Project <i className="fas fa-arrow-right" style={{ marginLeft: '8px' }}></i>
              </button>
      ...
      <section id="features" className="section-padding">
        <div className="container">
          <div className="text-center">
            <div className="subTitle">Web Development Services</div>
            <h2 className="secTitle">
              Digital Experiences <span>Engineered</span> for Impact
            </h2>
            <p style={{ color: '#5a5a72', maxWidth: '700px', margin: '0 auto' }}>
              Your website is your digital headquarters. We build fast, secure, and scalable web solutions tailored to your brand and business goals. 
              Whether you need a showcase site, an e-commerce platform, or a data-driven web GIS portal — we deliver code that works.
            </p>
          </div>
        ...
        <div className="container">
          <div className="achievement-wrap">
            <div className="achievement-content">
              ...
              <h2 className="secTitle">Web Development <span>Excellence</span></h2>
              <p style={{ color: '#4a4a62', marginBottom: '16px' }}>
                Delivering cutting-edge web solutions that combine stunning design, robust functionality, 
                and seamless user experiences for clients across industries.
              </p>
              <ul className="listItem">
                <li><i className="fas fa-check-circle"></i> Custom website design</li>
                <li><i className="fas fa-check-circle"></i> E-Commerce solutions</li>
                <li><i className="fas fa-check-circle"></i> Web GIS & mapping portals</li>
                <li><i className="fas fa-check-circle"></i> Web applications & dashboards</li>
              </ul>
              <button onClick={() => setShowModal(true)} className="berpo_btn">
      ...
      <section className="section-padding">
        <div className="container">
          <div className="text-center">
            ...
            <h2 className="secTitle">Our <span>Web</span> Capabilities</h2>
          </div>
          ...
          <div className="beproTab">
            ...
            <button
              className={`nav-link ${activeTab === 'webgis' ? 'active' : ''}`}
          ...
          <div className="tab-content">
            <div className={`tab-pane ${activeTab === 'design' ? 'active' : ''}`}>
              <div className="tab-content-inner">
                <div className="text-col">
                  <h2 className="secTitle" style={{ fontSize: '28px' }}>Custom <span>Web Design</span></h2>
                  <p>Fully responsive, mobile-first websites that reflect your brand identity. Clean UI/UX, intuitive navigation, and conversion-focused layouts.</p>
                  <button onClick={() => setShowModal(true)} className="berpo_btn" style={{ marginTop: '16px' }}>
                    Start Your Design
                  </button>
                </div>
                <div className="img-col">
                  <img src={aboutImg} alt="Web Design" />
                </div>
              </div>
            </div>
            <div className={`tab-pane ${activeTab === 'webgis' ? 'active' : ''}`}>
              <div className="tab-content-inner">
                <div className="text-col">
                  <h2 className="secTitle" style={{ fontSize: '28px' }}>Web GIS <span>& Mapping</span></h2>
                  <p>Interactive map dashboards, spatial data visualization, and location-based services using Leaflet, Mapbox GL, OpenLayers, or Esri JS API.</p>
                  <button onClick={() => setShowModal(true)} className="berpo_btn" style={{ marginTop: '16px' }}>
                    Build Your Web GIS
                  </button>
                </div>
                <div className="img-col">
                  <img src={aboutImg} alt="Web GIS" />
                </div>
              </div>
            </div>
            <div className={`tab-pane ${activeTab === 'apps' ? 'active' : ''}`}>
              <div className="tab-content-inner">
                <div className="text-col">
                  <h2 className="secTitle" style={{ fontSize: '28px' }}>Web Apps <span>& Dashboards</span></h2>
                  <p>Custom business tools, data dashboards, client portals, and internal systems with real-time updates and role-based access.</p>
                  <button onClick={() => setShowModal(true)} className="berpo_btn" style={{ marginTop: '16px' }}>
                    Build Your App
                  </button>
                </div>
                <div className="img-col">
                  <img src={aboutImg} alt="Web Apps" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding">
        <div className="container">
          <div className="text-center">
            ...
            <h2 className="secTitle">Latest <span>Web</span> Articles</h2>
          </div>
          ...
          <div className="cta-wrap">
            <div className="cta-content">
              ...
              <p style={{ color: '#b0b0c8', margin: '16px 0 24px', maxWidth: '90%' }}>
                Ready to transform your digital presence with a custom web solution?
              </p>
              <button onClick={() => setShowModal(true)} className="berpo_btn">
                Start Your Web Project
              </button>
        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-center mb-4">
              <div className="subTitle">Web Development Inquiry</div>
              <h2 className="secTitle">Start Your <span>Web Project</span></h2>
              <p style={{ color: '#5a5a72' }}>
                Tell us about your website needs — type of site, features, timeline, and budget range.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="Tell us about your website needs, features, and timeline..."
                />
              </div>
