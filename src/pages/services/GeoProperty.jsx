          ...
          <div className="testimonial-grid">
            <div>
              <div className="accordion">
                {[
                  { id: 1, q: 'What is SRIS?', a: 'SRIS (Spatial Revenue Intelligence System) is a Web GIS platform for mapping and managing municipal properties, assets, and revenue streams.' },
                  { id: 2, q: 'What data does SRIS handle?', a: 'SRIS handles building footprints, road networks, water connections, tax properties, professional tax, UGD networks, and public asset inventories.' },
                  { id: 3, q: 'How is SRIS deployed?', a: 'SRIS is deployed as a cloud-enabled platform with mobile field apps for data collection, web dashboards for monitoring, and integration with existing municipal systems.' }
                ].map((item) => (
      ...
      <section className="section-padding bg-light">
        <div className="container">
          <div className="text-center">
            ...
            <h2 className="secTitle">Meet Our <span>SRIS Team</span></h2>
          </div>
