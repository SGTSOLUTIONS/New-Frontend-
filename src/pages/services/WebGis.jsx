    ...
    <div className="service-page-wrapper">
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .service-page-wrapper .service-hero {
          ...
          position: relative;
          overflow: hidden;
          background-image: url('/assets/images/service/webgis.jpg');
        ...
        @media (max-width: 768px) {
          ...
          .service-page-wrapper .service-hero h1 { font-size: 2rem; }
      ...
      <div className="service-hero">
        <div className="container">
          ...
          <h1>Web GIS • Spatial Data Platforms</h1>
          <p>Interactive mapping portals, location intelligence dashboards, and geospatial data publishing — put your maps and analysis in the hands of every stakeholder, anywhere.</p>
        </div>
      </div>

      <div className="service-content">
        <div className="container">
          <h2 className="section-title">Maps That Work Across Your Organization</h2>
          <p className="lead-text">Web GIS transforms static spatial data into dynamic, interactive experiences. We build custom web mapping platforms that enable data visualization, querying, editing, and collaboration — accessible on desktop, tablet, and mobile without any GIS software required.</p>
          ...
          <div className="cta-center">
            <button className="btn-primary" onClick={() => setShowModal(true)}>
              <i className="fas fa-paper-plane"></i> Start Your Web GIS Project
            </button>
            <p style={{ marginTop: '1rem', fontSize: '0.85rem', color: '#4b5563' }}>Let's discuss your data and users — we'll build a Web GIS platform that turns location data into decisions.</p>
          </div>
        </div>
      </div>
      ...
      <div className="modal-overlay" onClick={() => setShowModal(false)}>
        <div className="modal-content" onClick={(e) => e.stopPropagation()}>
          <i className="fas fa-map-marked-alt" style={{ fontSize: '2.5rem', color: '#0891b2' }}></i>
          <h3 style={{ margin: '1rem 0 0.5rem' }}>Web GIS Project Inquiry</h3>
          <p style={{ marginBottom: '1rem' }}>Tell us about your spatial data, target users, required functionality, and timeline.</p>
          <form onSubmit={handleSubmit}>
            ...
            <textarea id="message" placeholder="Project description (data types, number of users, features: search, editing, dashboards, expected scale)" rows="2" value={formData.message} onChange={handleInputChange} />
