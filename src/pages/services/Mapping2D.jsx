...
const mappingFeatures = [
    {
        ...
        description: "Roads, buildings, water bodies, vegetation, and utility networks extracted from high-res imagery. Clean, editable vector layers for CAD and GIS.",
        image: mapFeature1,
        link: "/services/2d-mapping/planimetric",
    },
    {
        id: 2,
        icon: "fa-chart-line",
        title: "Topographic Contour Mapping",
        description: "1m, 2m, or 5m contours derived from photogrammetry or LiDAR. Ideal for civil design, flood modeling, and site grading analysis.",
        image: mapFeature2,
        link: "/services/2d-mapping/topographic",
    },
    {
        id: 3,
        icon: "fa-satellite-dish",
        title: "Satellite & Aerial Orthomosaics",
        description: "High-resolution seamless orthophotos (5cm to 50cm GSD) from drones, aircraft, or satellites. Georeferenced and ready for overlay.",
        image: mapFeature3,
        link: "/services/2d-mapping/orthomosaics",
    },
    {
        id: 4,
        icon: "fa-layer-group",
...
const testimonials = [
  {
    ...
    text: 'SGT Solutions delivered high-accuracy 2D mapping products for urban planning and infrastructure development across the city.',
    img: testimonial1
  },
  {
    id: 2,
    ...
    role: 'Envato Author',
    text: 'The thematic and land use maps provided by SGT Solutions were instrumental in our environmental restoration planning.',
    img: testimonial2
  },
  {
    id: 3,
    ...
    role: 'Envato Author',
    text: 'SGT Solutions completed comprehensive hydrographic mapping for water resource planning and flood modeling studies.',
    img: testimonial3
  },
];
...
const blogs = [
  {
    id: 1,
    title: 'The Art of Planimetric Mapping',
    date: '20 March, 2021',
  ...
  {
    id: 2,
    title: 'Topographic Mapping for Civil Design',
    date: '20 March, 2021',
    author: 'Keesler Smith',
    img: blog2,
  ...
  {
    id: 3,
    title: 'Land Use Classification Techniques',
    date: '20 March, 2021',
    author: 'Keesler Smith',
    img: blog3,
...
const Mapping2D = () => {
  ...
  const [activeTab, setActiveTab] = useState('planimetric');
  ...
  padding: 0 20px;
   ...
   .service_item_01 .ibMeta {
        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="hero-description">
              ...
              accurate 2D geospatial data from aerial imagery, satellite, and field surveys.
            </p>
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <button onClick={() => setShowModal(true)} className="berpo_btn">
                Request 2D Mapping Quote <i className="fas fa-arrow-right" style={{ marginLeft: '8px' }}></i>
              </button>
      ...
      <section id="features" className="section-padding">
        <div className="container">
          <div className="text-center">
            <div className="subTitle">2D Mapping Services</div>
            <h2 className="secTitle">
              Cartographic Excellence, <span>Geospatial</span> Precision
            </h2>
            <p style={{ color: '#5a5a72', maxWidth: '700px', margin: '0 auto' }}>
              2D mapping remains the backbone of planning, engineering, and environmental management. We produce high-fidelity planimetric maps, topographic sheets, thematic layers, and orthorectified imagery — all with survey-grade accuracy and rich attribution.
            </p>
          </div>

          <div className="service-grid">
            {mappingFeatures.map(feature => (
        ...
        <div className="container">
          <div className="achievement-wrap">
            <div className="achievement-content">
              ...
              <h2 className="secTitle">Mapping <span>Excellence</span></h2>
              <p style={{ color: '#4a4a62', marginBottom: '16px' }}>
                Delivering high-precision 2D mapping products for urban planning, infrastructure development, environmental management, and engineering design.
              </p>
              <ul className="listItem">
                <li><i className="fas fa-check-circle"></i> Planimetric mapping</li>
                <li><i className="fas fa-check-circle"></i> Topographic contour mapping</li>
                <li><i className="fas fa-check-circle"></i> Satellite & aerial orthomosaics</li>
                <li><i className="fas fa-check-circle"></i> Thematic & land use mapping</li>
              </ul>
              <button onClick={() => setShowModal(true)} className="berpo_btn">
                Get a Mapping Quote
              </button>
      ...
      <section className="section-padding">
        <div className="container">
          <div className="text-center">
            ...
            <h2 className="secTitle">Our <span>Mapping</span> Approaches</h2>
          </div>

          <div className="beproTab">
            <button
              className={`nav-link ${activeTab === 'planimetric' ? 'active' : ''}`}
              onClick={() => setActiveTab('planimetric')}
            >
              Planimetric
            </button>
            <button
              className={`nav-link ${activeTab === 'topographic' ? 'active' : ''}`}
              onClick={() => setActiveTab('topographic')}
            >
              Topographic
            </button>
            <button
              className={`nav-link ${activeTab === 'thematic' ? 'active' : ''}`}
          ...
          <div className="tab-content">
            <div className={`tab-pane ${activeTab === 'planimetric' ? 'active' : ''}`}>
              <div className="tab-content-inner">
                <div className="text-col">
                  <h2 className="secTitle" style={{ fontSize: '28px' }}>Planimetric <span>Mapping</span></h2>
                  <p>Roads, buildings, water bodies, vegetation, and utility networks extracted from high-res imagery. Clean, editable vector layers for CAD and GIS applications.</p>
                  <button onClick={() => setShowModal(true)} className="berpo_btn" style={{ marginTop: '16px' }}>
                    Request Planimetric Mapping
                  </button>
                </div>
                <div className="img-col">
                  <img src={aboutImg} alt="Planimetric" />
                </div>
              </div>
            </div>
            <div className={`tab-pane ${activeTab === 'topographic' ? 'active' : ''}`}>
              <div className="tab-content-inner">
                <div className="text-col">
                  <h2 className="secTitle" style={{ fontSize: '28px' }}>Topographic <span>Mapping</span></h2>
                  <p>1m, 2m, or 5m contours derived from photogrammetry or LiDAR. Ideal for civil design, flood modeling, and site grading analysis.</p>
                  <button onClick={() => setShowModal(true)} className="berpo_btn" style={{ marginTop: '16px' }}>
                    Request Topographic Mapping
                  </button>
                </div>
                <div className="img-col">
                  <img src={aboutImg} alt="Topographic" />
                </div>
              </div>
            </div>
            <div className={`tab-pane ${activeTab === 'thematic' ? 'active' : ''}`}>
              <div className="tab-content-inner">
                <div className="text-col">
                  <h2 className="secTitle" style={{ fontSize: '28px' }}>Thematic <span>Mapping</span></h2>
                  <p>Land cover classification, zoning maps, agricultural field boundaries, and environmental sensitivity layers — customized to your schema.</p>
                  <button onClick={() => setShowModal(true)} className="berpo_btn" style={{ marginTop: '16px' }}>
                    Request Thematic Mapping
                  </button>
                </div>
                <div className="img-col">
                  <img src={aboutImg} alt="Thematic" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding">
        <div className="container">
          <div className="text-center">
            ...
            <h2 className="secTitle">Latest <span>Mapping</span> Articles</h2>
          </div>
          ...
          <div className="cta-wrap">
            <div className="cta-content">
              ...
              <p style={{ color: '#b0b0c8', margin: '16px 0 24px', maxWidth: '90%' }}>
                Ready to transform your mapping projects with precision geospatial data?
              </p>
              <button onClick={() => setShowModal(true)} className="berpo_btn">
                Start Your Mapping Project
              </button>
            </div>
        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-center mb-4">
              <div className="subTitle">2D Mapping Inquiry</div>
              <h2 className="secTitle">Request a <span>Mapping Quote</span></h2>
